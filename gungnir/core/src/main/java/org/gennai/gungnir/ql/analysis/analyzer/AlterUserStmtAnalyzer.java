...
import org.gennai.gungnir.ql.task.AlterUserTask;

public class AlterUserStmtAnalyzer implements Analyzer<AlterUserTask> {

  @Override
  public AlterUserTask analyze(ASTNode node, SemanticAnalyzer semanticAnalyzer)
    ...
    return new AlterUserTask(user, semanticAnalyzer.getOwner());
  }
}
