...
public class ScriptFunction extends BaseScriptFunction {
  ...
  public ScriptFunction(FunctionEntity function, ScriptType scriptType, String classPath) {
    super(function, scriptType, classPath);
  }

  private ScriptFunction(ScriptFunction c) {
    super(c);
  }
  ...
  public ScriptFunction clone() {
    return new ScriptFunction(this);
  }
}
