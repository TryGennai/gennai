...
public class CreateFunctionTask implements Task {

  private FunctionEntity function;
  private FileRegistry fileRegistry;

  public CreateFunctionTask(FunctionEntity function, FileRegistry fileRegistry) {
  ...
  public String execute() throws TaskExecuteException {
    try {
      ...
      GungnirManager.getManager().getMetaStore().insertFunction(function);
    } catch (IOException e) {
      ...
      throw new TaskExecuteException(e);
    } catch (FunctionValidateException e) {
      throw new TaskExecuteException(e);
    }
    return "OK";
  }
