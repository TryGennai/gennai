...
public class ConditionAnalyzer implements Analyzer<Condition> {

  @Override
  public Condition analyze(ASTNode node, SemanticAnalyzer semanticAnalyzer)
      throws SemanticAnalyzeException {
    return semanticAnalyzer.analyzeByAnalyzer(node.getChild(0));
  }
}
