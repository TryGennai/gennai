...
public class ArrayAnalyzer implements Analyzer<Object[]> {
  ...
  public Object[] analyze(ASTNode node, SemanticAnalyzer semanticAnalyzer)
    ...
    Object[] elements = new Object[node.getChildCount()];
    for (int i = 0; i < node.getChildCount(); i++) {
      elements[i] = semanticAnalyzer.analyzeByAnalyzer(node.getChild(i));
    }
