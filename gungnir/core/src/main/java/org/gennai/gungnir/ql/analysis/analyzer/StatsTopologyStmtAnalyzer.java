...
import org.gennai.gungnir.ql.task.StatsTopologyTask;

public class StatsTopologyStmtAnalyzer implements Analyzer<StatsTopologyTask> {

  @Override
  public StatsTopologyTask analyze(ASTNode node, SemanticAnalyzer semanticAnalyzer)
    ...
    return new StatsTopologyTask(topologyName, semanticAnalyzer.getOwner(), extended);
  }
}
