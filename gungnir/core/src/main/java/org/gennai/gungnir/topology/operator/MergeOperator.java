...
@Operator.Description(name = "MERGE")
public class MergeOperator extends BaseOperator implements ExecOperator {
  ...
  private MergeOperator(MergeOperator c) {
    super(c);
  }
