...
public abstract class BaseTrigonometricFunction extends BaseFunction<Double> {

  private static final long serialVersionUID = SERIAL_VERSION_UID;

  public BaseTrigonometricFunction() {
  }

  protected BaseTrigonometricFunction(BaseTrigonometricFunction c) {
    super(c);
  }
  ...
  public Double evaluate(GungnirTuple tuple) {
    ...
    try {
      return evaluate(GungnirUtils.toDouble(value));
