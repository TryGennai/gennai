...
@Operator.Description(name = "FILTER", parameterNames = "condition")
public class FilterOperator extends BaseOperator implements ExecOperator {
  ...
  public FilterOperator(Condition condition) {
    super();
    this.condition = condition;
  }

  private FilterOperator(FilterOperator c) {
    super(c);
