...
@IS('Explain:
 ...
 TUPLE_JOIN_2((tuple1([tuple1:aaa.a1, tuple1:bbb]) JOIN tuple2([tuple2:eee.e2, tuple2:fff])), memory_cache(), 10SECONDS, tuple3, [tuple1:*, tuple2:*]) parallelism=2
...
SUBMIT TOPOLOGY tuplejoin6;

@POST('tuple1', '{aaa:{a1:"aaa1", a2:123}, bbb:10, ccc:100, ddd:"ddd11"}');
@POST('tuple1', '{aaa:{a1:"aaa1", a2:123}, bbb:10, ccc:100, ddd:"ddd12"}');
@POST('tuple1', '{aaa:{a1:"aaa1", a2:123}, bbb:10, ccc:100, ddd:"ddd13"}');
@POST('tuple1', '{aaa:{a1:"bbb1", a2:123}, bbb:10, ccc:100, ddd:"ddd13"}');
@PLAY(5);

@TIMER(+20);

@POST('tuple1', '{aaa:{a1:"aaa1", a2:123}, bbb:10, ccc:100, ddd:"ddd1"}');
@POST('tuple1', '{aaa:{a1:"aaa1", a2:123}, bbb:10, ccc:100, ddd:"ddd2"}');
@POST('tuple1', '{aaa:{a1:"aaa1", a2:123}, bbb:10, ccc:100, ddd:"ddd3"}');
@PLAY(3);

@POST('tuple2', '{eee:{e1:456, e2:"aaa1"}, fff:10, ggg:101, hhh:"ddd2"}');
@POST('tuple2', '{eee:{e1:456, e2:"bbb1"}, fff:10, ggg:101, hhh:"ddd2"}');
@EMIT('EMIT_4', '{aaa:{a1:"aaa1", a2:123}, bbb:10, ccc:100, ddd:"ddd1", eee:{e1:456, e2:"aaa1"}, fff:10, ggg:101, hhh:"ddd2"}');
@EMIT('EMIT_4', '{aaa:{a1:"aaa1", a2:123}, bbb:10, ccc:100, ddd:"ddd2", eee:{e1:456, e2:"aaa1"}, fff:10, ggg:101, hhh:"ddd2"}');
@EMIT('EMIT_4', '{aaa:{a1:"aaa1", a2:123}, bbb:10, ccc:100, ddd:"ddd3", eee:{e1:456, e2:"aaa1"}, fff:10, ggg:101, hhh:"ddd2"}');
@PLAY(60);

STOP TOPOLOGY tuplejoin6;
