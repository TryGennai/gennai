...
FROM
 (s1(tuple1)
  JOIN s1(tuple2) ON tuple1.aaa = tuple2.eee
  TO tuple1.*, tuple2.*
  EXPIRE 1min
  USING file_cache()
 ) AS tuple3
...
@IS('Explain:
 ...
 TUPLE_JOIN_2((tuple1(tuple1:aaa) JOIN tuple2(tuple2:eee)), file_cache(), 1MINUTES, tuple3, [tuple1:*, tuple2:*]) parallelism=3
  -S(tuple3)-> EMIT_3
