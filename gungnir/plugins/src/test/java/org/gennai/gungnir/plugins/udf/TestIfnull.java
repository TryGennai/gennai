...
public class TestIfnull {
  ...
  public void testInvoke() throws Exception {
    ...
    GungnirTuple tuple = GungnirTuple.builder(schema).put("f1", "test").put("f2", null).build();

    assertThat((String) FunctionInvoker.create(Ifnull.class, field("f2"), "def")
        .evaluate(tuple), is("def"));

    assertThat((String) FunctionInvoker.create(Ifnull.class, field("f1"), "def")
        .evaluate(tuple), is("test"));
  }
}
