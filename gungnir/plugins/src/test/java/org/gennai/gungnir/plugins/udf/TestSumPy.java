...
public class TestSumPy {
  ...
  public void testInvoke() throws Exception {
    ...
    ScriptFunctionInvoker invoker = ScriptFunctionInvoker.create("sum.py", field("f2"));
    assertThat((Integer) invoker.evaluate(tuple), is(123));
    assertThat((Integer) invoker.evaluate(tuple2), is(160));
    assertThat((Integer) invoker.evaluate(tuple5), is(160));
    assertThat((Integer) invoker.evaluate(tuple6), is(160));
    assertThat((Integer) invoker.evaluate(tuple3), is(180));
    assertThat((Integer) invoker.exclude(tuple), is(57));
    invoker.clear();
    ...
    ScriptFunctionInvoker invoker2 = ScriptFunctionInvoker.create("sum.py", field("f2"));
    assertThat((Integer) invoker2.evaluate(tuple), is(123));
    assertThat((Integer) invoker2.evaluate(tuple), is(246));
  }
}
