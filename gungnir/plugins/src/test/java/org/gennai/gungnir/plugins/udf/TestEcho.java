...
public class TestEcho {
  ...
  public void testInvoke() throws Exception {
    ...
    assertThat((String) FunctionInvoker.create(Echo.class, field("f1")).evaluate(tuple),
        is("1:test"));

    assertThat((String) FunctionInvoker.create(Echo.class, field("f1"), field("f2"))
        .evaluate(tuple), is("1:test, 2:123"));

    assertThat((String) FunctionInvoker.create(Echo.class, "test2", field("f2"))
        .evaluate(tuple), is("1:test2, 2:123"));
  }
}
